...
\textbf{Pillar 4: Data Network Effects.} As we deploy with customers like Google Fiber and Ziply Fiber, we gain access to unique network data that allows us to train increasingly sophisticated GNN models. This creates a powerful data advantage over time, as our models become more accurate and predictive than any competitor's.
